define([
    ...
    return Marionette.LayoutView.extend({
        ...
        onShow: function() {
            this.repoDetailsSummaryHeaderContainer.show(new RepositoryDetailsView({model: this.model, session: this.options.session}));
            ...
            this.repoDetailsLanguagesContainer.show(new RepositoryLanguagesListView({model: languages, repository: this.model, session: this.options.session}));
        }
    });
